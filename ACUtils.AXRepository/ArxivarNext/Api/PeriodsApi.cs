...
namespace ACUtils.AXRepository.ArxivarNext.Api
{
    ...
    public partial class PeriodsApi : IPeriodsApi
    {
        ...
        /// <returns></returns>
        public PeriodsApi(ACUtils.AXRepository.ArxivarNext.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< List<PeriodDTO> > PeriodsGetPeriodsWithHttpInfo ()
        {
            ...
            return new ApiResponse<List<PeriodDTO>>(localVarStatusCode,
                ...
                (List<PeriodDTO>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<PeriodDTO>)));
        }
