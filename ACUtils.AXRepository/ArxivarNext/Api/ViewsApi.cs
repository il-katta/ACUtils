...
namespace ACUtils.AXRepository.ArxivarNext.Api
{
        ...
        public interface IViewsApi : IApiAccessor
    {
        ...
        List<RowSearchResult> ViewsGetResult (ViewDTO body = null);
        ...
        ApiResponse<List<RowSearchResult>> ViewsGetResultWithHttpInfo (ViewDTO body = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<List<RowSearchResult>> ViewsGetResultAsync (ViewDTO body = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<RowSearchResult>>> ViewsGetResultAsyncWithHttpInfo (ViewDTO body = null);
        /// <summary>
        /// This call returns the view with all information
        /// </summary>
        /// <remarks>
        ...
        public partial class ViewsApi : IViewsApi
    {
        ...
        /// <returns></returns>
        public ViewsApi(ACUtils.AXRepository.ArxivarNext.Client.Configuration configuration = null)
        {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>List&lt;RowSearchResult&gt;</returns>
        public List<RowSearchResult> ViewsGetResult (ViewDTO body = null)
        {
             ApiResponse<List<RowSearchResult>> localVarResponse = ViewsGetResultWithHttpInfo(body);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of List&lt;RowSearchResult&gt;</returns>
        public ApiResponse< List<RowSearchResult> > ViewsGetResultWithHttpInfo (ViewDTO body = null)
        {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of List&lt;RowSearchResult&gt;</returns>
        public async System.Threading.Tasks.Task<List<RowSearchResult>> ViewsGetResultAsync (ViewDTO body = null)
        {
             ApiResponse<List<RowSearchResult>> localVarResponse = await ViewsGetResultAsyncWithHttpInfo(body);
             return localVarResponse.Data;
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;RowSearchResult&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<RowSearchResult>>> ViewsGetResultAsyncWithHttpInfo (ViewDTO body = null)
        {
