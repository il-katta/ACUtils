...
namespace ACUtils.AXRepository.ArxivarNext.Api
{
        ...
        public interface IWorkflowApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="ACUtils.AXRepository.ArxivarNext.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">List of document identifier</param>
        /// <returns>List&lt;WorkFlowEventDTO&gt;</returns>
        List<WorkFlowEventDTO> WorkflowGetEventsForManualStarts (List<int?> body);
        ...
        /// <param name="body">List of document identifier</param>
        /// <returns>ApiResponse of List&lt;WorkFlowEventDTO&gt;</returns>
        ApiResponse<List<WorkFlowEventDTO>> WorkflowGetEventsForManualStartsWithHttpInfo (List<int?> body);
        /// <summary>
        ...
        /// <param name="body">List of document identifier</param>
        /// <returns>Task of List&lt;WorkFlowEventDTO&gt;</returns>
        System.Threading.Tasks.Task<List<WorkFlowEventDTO>> WorkflowGetEventsForManualStartsAsync (List<int?> body);
        ...
        /// <param name="body">List of document identifier</param>
        /// <returns>Task of ApiResponse (List&lt;WorkFlowEventDTO&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<WorkFlowEventDTO>>> WorkflowGetEventsForManualStartsAsyncWithHttpInfo (List<int?> body);
        /// <summary>
        /// This call retruns all external identifier of tasks
        /// </summary>
        /// <remarks>
        ...
        public partial class WorkflowApi : IWorkflowApi
    {
        ...
        /// <param name="body">List of document identifier</param>
        /// <returns>List&lt;WorkFlowEventDTO&gt;</returns>
        public List<WorkFlowEventDTO> WorkflowGetEventsForManualStarts (List<int?> body)
        {
             ApiResponse<List<WorkFlowEventDTO>> localVarResponse = WorkflowGetEventsForManualStartsWithHttpInfo(body);
             return localVarResponse.Data;
        }
        ...
        /// <param name="body">List of document identifier</param>
        /// <returns>ApiResponse of List&lt;WorkFlowEventDTO&gt;</returns>
        public ApiResponse< List<WorkFlowEventDTO> > WorkflowGetEventsForManualStartsWithHttpInfo (List<int?> body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling WorkflowApi->WorkflowGetEventsForManualStarts");
        ...
        /// <param name="body">List of document identifier</param>
        /// <returns>Task of List&lt;WorkFlowEventDTO&gt;</returns>
        public async System.Threading.Tasks.Task<List<WorkFlowEventDTO>> WorkflowGetEventsForManualStartsAsync (List<int?> body)
        {
             ApiResponse<List<WorkFlowEventDTO>> localVarResponse = await WorkflowGetEventsForManualStartsAsyncWithHttpInfo(body);
             return localVarResponse.Data;
        ...
        /// <param name="body">List of document identifier</param>
        /// <returns>Task of ApiResponse (List&lt;WorkFlowEventDTO&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<WorkFlowEventDTO>>> WorkflowGetEventsForManualStartsAsyncWithHttpInfo (List<int?> body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling WorkflowApi->WorkflowGetEventsForManualStarts");
