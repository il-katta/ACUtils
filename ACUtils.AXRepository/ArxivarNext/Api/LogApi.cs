...
namespace ACUtils.AXRepository.ArxivarNext.Api
{
        ...
        public interface ILogApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="ACUtils.AXRepository.ArxivarNext.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">Model for log writing</param>
        /// <returns>bool?</returns>
        bool? LogWriteDocnumberLog (DocnumberLogDTO body);
        ...
        ApiResponse<bool?> LogWriteDocnumberLogWithHttpInfo (DocnumberLogDTO body);
        /// <summary>
        /// This call writes a log document
        /// </summary>
        /// <remarks>
        ...
        /// <returns>bool?</returns>
        bool? LogWriteDocnumberLog (int? docnumber, string message, int? level);
        ...
        /// <param name="level"></param>
        /// <returns>ApiResponse of bool?</returns>
        ApiResponse<bool?> LogWriteDocnumberLogWithHttpInfo (int? docnumber, string message, int? level);
        ...
        System.Threading.Tasks.Task<bool?> LogWriteDocnumberLogAsync (DocnumberLogDTO body);
        ...
        System.Threading.Tasks.Task<ApiResponse<bool?>> LogWriteDocnumberLogAsyncWithHttpInfo (DocnumberLogDTO body);
        /// <summary>
        /// This call writes a log document
        /// </summary>
        /// <remarks>
        ...
        /// <param name="level"></param>
        /// <returns>Task of bool?</returns>
        System.Threading.Tasks.Task<bool?> LogWriteDocnumberLogAsync (int? docnumber, string message, int? level);
        ...
        /// <param name="level"></param>
        /// <returns>Task of ApiResponse (bool?)</returns>
        System.Threading.Tasks.Task<ApiResponse<bool?>> LogWriteDocnumberLogAsyncWithHttpInfo (int? docnumber, string message, int? level);
        ...
        public partial class LogApi : ILogApi
    {
        ...
        /// <returns></returns>
        public LogApi(ACUtils.AXRepository.ArxivarNext.Client.Configuration configuration = null)
        {
        ...
        /// <param name="body">Model for log writing</param>
        /// <returns>bool?</returns>
        public bool? LogWriteDocnumberLog (DocnumberLogDTO body)
        {
             ApiResponse<bool?> localVarResponse = LogWriteDocnumberLogWithHttpInfo(body);
             return localVarResponse.Data;
        }
        ...
        /// <param name="body">Model for log writing</param>
        /// <returns>ApiResponse of bool?</returns>
        public ApiResponse< bool? > LogWriteDocnumberLogWithHttpInfo (DocnumberLogDTO body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling LogApi->LogWriteDocnumberLog");
        ...
        /// <param name="body">Model for log writing</param>
        /// <returns>Task of bool?</returns>
        public async System.Threading.Tasks.Task<bool?> LogWriteDocnumberLogAsync (DocnumberLogDTO body)
        {
             ApiResponse<bool?> localVarResponse = await LogWriteDocnumberLogAsyncWithHttpInfo(body);
             return localVarResponse.Data;
        ...
        /// <param name="body">Model for log writing</param>
        /// <returns>Task of ApiResponse (bool?)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<bool?>> LogWriteDocnumberLogAsyncWithHttpInfo (DocnumberLogDTO body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling LogApi->LogWriteDocnumberLog");
        ...
        /// <param name="level"></param>
        /// <returns>bool?</returns>
        public bool? LogWriteDocnumberLog (int? docnumber, string message, int? level)
        {
             ApiResponse<bool?> localVarResponse = LogWriteDocnumberLogWithHttpInfo(docnumber, message, level);
             return localVarResponse.Data;
        }
        ...
        /// <param name="level"></param>
        /// <returns>ApiResponse of bool?</returns>
        public ApiResponse< bool? > LogWriteDocnumberLogWithHttpInfo (int? docnumber, string message, int? level)
        {
            // verify the required parameter 'docnumber' is set
            if (docnumber == null)
                throw new ApiException(400, "Missing required parameter 'docnumber' when calling LogApi->LogWriteDocnumberLog");
            // verify the required parameter 'message' is set
            if (message == null)
                throw new ApiException(400, "Missing required parameter 'message' when calling LogApi->LogWriteDocnumberLog");
            // verify the required parameter 'level' is set
            if (level == null)
                throw new ApiException(400, "Missing required parameter 'level' when calling LogApi->LogWriteDocnumberLog");
            ...
            if (level != null) localVarFormParams.Add("level", this.Configuration.ApiClient.ParameterToString(level)); // form parameter
            // authentication (Authorization) required
            if (!String.IsNullOrEmpty(this.Configuration.GetApiKeyWithPrefix("Authorization")))
            {
                localVarHeaderParams["Authorization"] = this.Configuration.GetApiKeyWithPrefix("Authorization");
        ...
        /// <param name="level"></param>
        /// <returns>Task of bool?</returns>
        public async System.Threading.Tasks.Task<bool?> LogWriteDocnumberLogAsync (int? docnumber, string message, int? level)
        {
             ApiResponse<bool?> localVarResponse = await LogWriteDocnumberLogAsyncWithHttpInfo(docnumber, message, level);
             return localVarResponse.Data;
        ...
        /// <param name="level"></param>
        /// <returns>Task of ApiResponse (bool?)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<bool?>> LogWriteDocnumberLogAsyncWithHttpInfo (int? docnumber, string message, int? level)
        {
            // verify the required parameter 'docnumber' is set
            if (docnumber == null)
                throw new ApiException(400, "Missing required parameter 'docnumber' when calling LogApi->LogWriteDocnumberLog");
