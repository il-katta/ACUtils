...
namespace ACUtils.AXRepository.ArxivarNext.Api
{
        ...
        public interface IGlobalSearchApi : IApiAccessor
    {
        ...
        /// <returns>List&lt;RowSearchResult&gt;</returns>
        List<RowSearchResult> GlobalSearchGetFullIndexSearch_0 (FullIndexSearchRequestDto body = null);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of List&lt;RowSearchResult&gt;</returns>
        ApiResponse<List<RowSearchResult>> GlobalSearchGetFullIndexSearch_0WithHttpInfo (FullIndexSearchRequestDto body = null);
        /// <summary>
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of List&lt;RowSearchResult&gt;</returns>
        System.Threading.Tasks.Task<List<RowSearchResult>> GlobalSearchGetFullIndexSearch_0Async (FullIndexSearchRequestDto body = null);
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;RowSearchResult&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<RowSearchResult>>> GlobalSearchGetFullIndexSearch_0AsyncWithHttpInfo (FullIndexSearchRequestDto body = null);
        /// <summary>
        /// This call returns all elements match the given filter
        /// </summary>
        /// <remarks>
        ...
        public partial class GlobalSearchApi : IGlobalSearchApi
    {
        ...
        /// <returns></returns>
        public GlobalSearchApi(ACUtils.AXRepository.ArxivarNext.Client.Configuration configuration = null)
        {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>ApiResponse of List&lt;RowSearchResult&gt;</returns>
        public ApiResponse< List<RowSearchResult> > GlobalSearchGetFullIndexSearch_0WithHttpInfo (FullIndexSearchRequestDto body = null)
        {
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of List&lt;RowSearchResult&gt;</returns>
        public async System.Threading.Tasks.Task<List<RowSearchResult>> GlobalSearchGetFullIndexSearch_0Async (FullIndexSearchRequestDto body = null)
        {
             ApiResponse<List<RowSearchResult>> localVarResponse = await GlobalSearchGetFullIndexSearch_0AsyncWithHttpInfo(body);
             return localVarResponse.Data;
        ...
        /// <param name="body"> (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;RowSearchResult&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<RowSearchResult>>> GlobalSearchGetFullIndexSearch_0AsyncWithHttpInfo (FullIndexSearchRequestDto body = null)
        {
