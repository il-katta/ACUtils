...
namespace ACUtils.AXRepository.ArxivarNext.Api
{
    ...
    public partial class DocToOcrApi : IDocToOcrApi
    {
        ...
        /// <returns></returns>
        public DocToOcrApi(ACUtils.AXRepository.ArxivarNext.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< List<DocToOcrDTO> > DocToOcrGetByDocnumberWithHttpInfo (int? docnumber)
        {
            ...
            return new ApiResponse<List<DocToOcrDTO>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (List<DocToOcrDTO>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<DocToOcrDTO>)));
        }
