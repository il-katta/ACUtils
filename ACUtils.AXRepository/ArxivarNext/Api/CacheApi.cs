...
namespace ACUtils.AXRepository.ArxivarNext.Api
{
    ...
    public interface ICacheApi : IApiAccessor
    {
        ...
        List<string> CacheInsert(byte[] file);
        ...
        ApiResponse<List<string>> CacheInsertWithHttpInfo(byte[] file);
        ...
        System.Threading.Tasks.Task<List<string>> CacheInsertAsync(byte[] file);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<string>>> CacheInsertAsyncWithHttpInfo(byte[] file);
    ...
    public partial class CacheApi : ICacheApi
    {
        ...
        /// <returns></returns>
        public CacheApi(ACUtils.AXRepository.ArxivarNext.Client.Configuration configuration = null)
        {
        ...
        /// <param name="file"></param>
        /// <returns>List&lt;string&gt;</returns>
        public List<string> CacheInsert(byte[] file)
        {
        ...
        /// <param name="file"></param>
        /// <returns>ApiResponse of List&lt;string&gt;</returns>
        public ApiResponse<List<string>> CacheInsertWithHttpInfo(byte[] file)
        {
        ...
        /// <param name="file"></param>
        /// <returns>Task of List&lt;string&gt;</returns>
        public async System.Threading.Tasks.Task<List<string>> CacheInsertAsync(byte[] file)
        {
        ...
        /// <param name="file"></param>
        /// <returns>Task of ApiResponse (List&lt;string&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<string>>> CacheInsertAsyncWithHttpInfo(byte[] file)
        {
            // verify the required parameter 'file' is set
            if (file == null)
                throw new ApiException(400, "Missing required parameter 'file' when calling CacheApi->CacheInsert");
