...
namespace ACUtils.AXRepository.ArxivarNext.Api
{
    ...
    public partial class ChatApi : IChatApi
    {
        ...
        public ApiResponse< ShareObjectOptionsDTO > ChatGetShareOptionsWithHttpInfo (ShareObjectBaseDTO shareObject)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(shareObject); // http body (model) parameter
            }
            else
            {
        ...
        public ApiResponse<Object> ChatSetSettingsWithHttpInfo (ChatServiceSettingsDTO chatServiceSettings)
        {
            ...
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(chatServiceSettings); // http body (model) parameter
            }
            else
            {
