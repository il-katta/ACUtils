...
namespace ACUtils.AXRepository.ArxivarNext.Api
{
        ...
        public interface IUserSearchV3Api : IApiAccessor
    {
        ...
        Object UserSearchV3PostSearch (UserSearchCriteriaDTO body);
        ...
        ApiResponse<Object> UserSearchV3PostSearchWithHttpInfo (UserSearchCriteriaDTO body);
        /// <summary>
        /// This call searches in user with search and select DTO system.  This call could not be compatible with some programming language, in this case use the call api/UserSearches
        /// </summary>
        /// <remarks>
        ...
        /// <returns>Object</returns>
        Object UserSearchV3PostSearch (UserSearchDTO searchDto, SelectDTO selectDto);
        ...
        /// <param name="selectDto"></param>
        /// <returns>ApiResponse of Object</returns>
        ApiResponse<Object> UserSearchV3PostSearchWithHttpInfo (UserSearchDTO searchDto, SelectDTO selectDto);
        ...
        System.Threading.Tasks.Task<Object> UserSearchV3PostSearchAsync (UserSearchCriteriaDTO body);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> UserSearchV3PostSearchAsyncWithHttpInfo (UserSearchCriteriaDTO body);
        /// <summary>
        /// This call searches in user with search and select DTO system.  This call could not be compatible with some programming language, in this case use the call api/UserSearches
        /// </summary>
        /// <remarks>
        ...
        /// <param name="selectDto"></param>
        /// <returns>Task of Object</returns>
        System.Threading.Tasks.Task<Object> UserSearchV3PostSearchAsync (UserSearchDTO searchDto, SelectDTO selectDto);
        ...
        /// <param name="selectDto"></param>
        /// <returns>Task of ApiResponse (Object)</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> UserSearchV3PostSearchAsyncWithHttpInfo (UserSearchDTO searchDto, SelectDTO selectDto);
        ...
        public partial class UserSearchV3Api : IUserSearchV3Api
    {
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of Object</returns>
        public ApiResponse< Object > UserSearchV3PostSearchWithHttpInfo (UserSearchCriteriaDTO body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling UserSearchV3Api->UserSearchV3PostSearch");
        ...
        /// <param name="body"></param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> UserSearchV3PostSearchAsyncWithHttpInfo (UserSearchCriteriaDTO body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling UserSearchV3Api->UserSearchV3PostSearch");
        ...
        /// <param name="selectDto"></param>
        /// <returns>ApiResponse of Object</returns>
        public ApiResponse< Object > UserSearchV3PostSearchWithHttpInfo (UserSearchDTO searchDto, SelectDTO selectDto)
        {
            // verify the required parameter 'searchDto' is set
            if (searchDto == null)
                throw new ApiException(400, "Missing required parameter 'searchDto' when calling UserSearchV3Api->UserSearchV3PostSearch");
            // verify the required parameter 'selectDto' is set
            if (selectDto == null)
                throw new ApiException(400, "Missing required parameter 'selectDto' when calling UserSearchV3Api->UserSearchV3PostSearch");
        ...
        /// <param name="selectDto"></param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> UserSearchV3PostSearchAsyncWithHttpInfo (UserSearchDTO searchDto, SelectDTO selectDto)
        {
            // verify the required parameter 'searchDto' is set
            if (searchDto == null)
                throw new ApiException(400, "Missing required parameter 'searchDto' when calling UserSearchV3Api->UserSearchV3PostSearch");
