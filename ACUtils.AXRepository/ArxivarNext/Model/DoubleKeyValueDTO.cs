...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DoubleKeyValueDTO : GenericKeyValueDTO,  IEquatable<DoubleKeyValueDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DoubleKeyValueDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DoubleKeyValueDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DoubleKeyValueDTO" /> class.
        /// </summary>
        /// <param name="value">Value.</param>
        public DoubleKeyValueDTO(double? value = default(double?), string className = "DoubleKeyValueDTO", string key = default(string)) : base(className, key)
        {
            this.Value = value;
        }
