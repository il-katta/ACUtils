...
{
    /// <summary>
    /// Authentication token request by logon ticket
    /// </summary>
    [DataContract]
    public partial class AuthenticationTokenByLogonTicketRequestDTO :  IEquatable<AuthenticationTokenByLogonTicketRequestDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticationTokenByLogonTicketRequestDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthenticationTokenByLogonTicketRequestDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticationTokenByLogonTicketRequestDTO" /> class.
        /// </summary>
        /// <param name="logonTicket">Logon ticket (required).</param>
        ...
        public AuthenticationTokenByLogonTicketRequestDTO(string logonTicket = default(string), string clientId = default(string), string clientSecret = default(string), string logonProviderId = default(string), int? impersonateUserId = default(int?), string impersonateExternalId = default(string), string clientVersion = default(string), string machineKey = default(string), string languageCultureName = default(string), string successRedirectUri = default(string), List<string> scopeList = default(List<string>), string clientIpAddress = default(string))
        {
            ...
            if (clientId == null)
            {
                throw new InvalidDataException("clientId is a required property for AuthenticationTokenByLogonTicketRequestDTO and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("clientSecret is a required property for AuthenticationTokenByLogonTicketRequestDTO and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthenticationTokenByLogonTicketRequestDTO {\n");
        ...
        {
            return this.Equals(input as AuthenticationTokenByLogonTicketRequestDTO);
        }

        /// <summary>
        /// Returns true if AuthenticationTokenByLogonTicketRequestDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticationTokenByLogonTicketRequestDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticationTokenByLogonTicketRequestDTO input)
        {
            if (input == null)
                return false;
