...
{
    /// <summary>
    /// Class of additional field for Boolean type
    /// </summary>
    [DataContract]
    public partial class AdditionalFieldBooleanDTO : FieldBaseDTO,  IEquatable<AdditionalFieldBooleanDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdditionalFieldBooleanDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdditionalFieldBooleanDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdditionalFieldBooleanDTO" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdditionalFieldBooleanDTO {\n");
        ...
        {
            return this.Equals(input as AdditionalFieldBooleanDTO);
        }

        /// <summary>
        /// Returns true if AdditionalFieldBooleanDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of AdditionalFieldBooleanDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdditionalFieldBooleanDTO input)
        {
            if (input == null)
                return false;
