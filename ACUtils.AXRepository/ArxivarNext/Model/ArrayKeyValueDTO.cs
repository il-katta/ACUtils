...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ArrayKeyValueDTO : GenericKeyValueDTO,  IEquatable<ArrayKeyValueDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArrayKeyValueDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ArrayKeyValueDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ArrayKeyValueDTO" /> class.
        /// </summary>
        /// <param name="values">Values.</param>
        public ArrayKeyValueDTO(List<GenericKeyValueDTO> values = default(List<GenericKeyValueDTO>), string className = "ArrayKeyValueDTO", string key = default(string)) : base(className, key)
        {
            this.Values = values;
        }
