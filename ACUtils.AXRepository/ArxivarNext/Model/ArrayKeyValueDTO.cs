...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
        ...
        public partial class ArrayKeyValueDTO : GenericKeyValueDTO,  IEquatable<ArrayKeyValueDTO>, IValidatableObject
    {
        ...
        public ArrayKeyValueDTO(List<GenericKeyValueDTO> values = default(List<GenericKeyValueDTO>), string className = default(string), string key = default(string)) : base(className, key)
        {
            this.Values = values;
        }
