...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FieldDateTime :  IEquatable<FieldDateTime>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FieldDateTime" /> class.
        /// </summary>
        ...
        public FieldDateTime(Object valore2 = default(Object), Object valore = default(Object), int? operatore = default(int?), string nome = default(string), string nomeTabella = default(string), string externalId = default(string), string multiple = default(string), string label = default(string))
        {
        ...
        {
            return this.Equals(input as FieldDateTime);
        }

        /// <summary>
        /// Returns true if FieldDateTime instances are equal
        /// </summary>
        /// <param name="input">Instance of FieldDateTime to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FieldDateTime input)
        {
            if (input == null)
                return false;
