...
{
    /// <summary>
    /// AddressBookSearchListCriteriaDTO
    /// </summary>
    [DataContract]
        public partial class AddressBookSearchListCriteriaDTO :  IEquatable<AddressBookSearchListCriteriaDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressBookSearchListCriteriaDTO" /> class.
        /// </summary>
        ...
        public AddressBookSearchListCriteriaDTO(List<int?> addressBookCategoryId = default(List<int?>), List<RubricaFieldDTO> filterFields = default(List<RubricaFieldDTO>), List<RubricaFieldDTO> selectFields = default(List<RubricaFieldDTO>), string filter = default(string))
        {
        ...
        public List<int?> AddressBookCategoryId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressBookSearchListCriteriaDTO {\n");
        ...
        {
            return this.Equals(input as AddressBookSearchListCriteriaDTO);
        }

        /// <summary>
        /// Returns true if AddressBookSearchListCriteriaDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressBookSearchListCriteriaDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressBookSearchListCriteriaDTO input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    input.AddressBookCategoryId != null &&
                    this.AddressBookCategoryId.SequenceEqual(input.AddressBookCategoryId)
                ) && 
                (
                    this.FilterFields == input.FilterFields ||
                    this.FilterFields != null &&
                    input.FilterFields != null &&
                    this.FilterFields.SequenceEqual(input.FilterFields)
                ) && 
                (
                    this.SelectFields == input.SelectFields ||
                    this.SelectFields != null &&
                    input.SelectFields != null &&
