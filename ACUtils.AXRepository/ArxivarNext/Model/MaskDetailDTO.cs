...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
        ...
        public partial class MaskDetailDTO :  IEquatable<MaskDetailDTO>, IValidatableObject
    {
        ...
        public MaskDetailDTO(string id = default(string), string maskId = default(string), string fieldName = default(string), string label = default(string), int? order = default(int?), bool? _readOnly = default(bool?), bool? required = default(bool?), int? detailKind = default(int?), string visibilityCondition = default(string), int? addressBookDefaultFilter = default(int?), List<int?> enabledAddressBook = default(List<int?>), List<MaskDetailTranslationDTO> translations = default(List<MaskDetailTranslationDTO>), int? columns = default(int?))
        {
            this.Id = id;
            this.MaskId = maskId;
