...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
    ...
    public partial class SignOperationElementDTO :  IEquatable<SignOperationElementDTO>, IValidatableObject
    {
        ...
        [DataMember(Name="docTable", EmitDefaultValue=false)]
        public int? DocTable { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SignOperationElementDTO {\n");
        ...
        {
            return this.Equals(input as SignOperationElementDTO);
        }

        /// <summary>
        /// Returns true if SignOperationElementDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SignOperationElementDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignOperationElementDTO input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.DocTable == input.DocTable ||
                    (this.DocTable != null &&
                    this.DocTable.Equals(input.DocTable))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DocTable != null)
                    hashCode = hashCode * 59 + this.DocTable.GetHashCode();
                if (this.DocId != null)
