...
{
    /// <summary>
    /// Class of the adress book item V4
    /// </summary>
    [DataContract]
        public partial class AddressBookV4DTO :  IEquatable<AddressBookV4DTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressBookV4DTO" /> class.
        /// </summary>
        /// <param name="contacts">Contacts V4.</param>
        ...
        public AddressBookV4DTO(List<ContactV4DTO> contacts = default(List<ContactV4DTO>), string officeCode = default(string), string publicAdministrationCode = default(string), string pecAddressBook = default(string), int? id = default(int?), string businessName = default(string), string fax = default(string), string address = default(string), string location = default(string), string postalCode = default(string), string province = default(string), string country = default(string), string email = default(string), string phoneNumber = default(string), string cellPhone = default(string), int? state = default(int?), int? type = default(int?), int? addressBookCategoryId = default(int?), string businessUnit = default(string), string _class = default(string), string fiscalCode = default(string), string vatNumber = default(string), int? priority = default(int?), string addressBookBusinessUnitCode = default(string), string addressBookNote = default(string), string externalCode = default(string), AdditionalConcreteFields additionalFields = default(AdditionalConcreteFields))
        {
        ...
        /// Contacts V4
        /// </summary>
        /// <value>Contacts V4</value>
        [DataMember(Name="contacts", EmitDefaultValue=false)]
        public List<ContactV4DTO> Contacts { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressBookV4DTO {\n");
        ...
        {
            return this.Equals(input as AddressBookV4DTO);
        }

        /// <summary>
        /// Returns true if AddressBookV4DTO instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressBookV4DTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressBookV4DTO input)
        {
            if (input == null)
                return false;
