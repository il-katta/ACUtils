...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SearchCriteriaDto :  IEquatable<SearchCriteriaDto>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SearchCriteriaDto);
        }

        /// <summary>
        /// Returns true if SearchCriteriaDto instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchCriteriaDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchCriteriaDto input)
        {
            if (input == null)
                return false;
