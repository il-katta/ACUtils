...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
        ...
        public partial class UserInfoDTO :  IEquatable<UserInfoDTO>, IValidatableObject
    {
        ...
        public List<RolesInfoDto> Roles { get; set; }
        ...
        public bool Equals(UserInfoDTO input)
        {
            ...
            return 
                ...
                (
                    this.IsUnicode == input.IsUnicode ||
                    (this.IsUnicode != null &&
                    this.IsUnicode.Equals(input.IsUnicode))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsUnicode != null)
                    hashCode = hashCode * 59 + this.IsUnicode.GetHashCode();
