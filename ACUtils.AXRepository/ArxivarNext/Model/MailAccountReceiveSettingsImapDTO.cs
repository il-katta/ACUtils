...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MailAccountReceiveSettingsImapDTO : MailAccountReceiveSettingsDTO,  IEquatable<MailAccountReceiveSettingsImapDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MailAccountReceiveSettingsImapDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MailAccountReceiveSettingsImapDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MailAccountReceiveSettingsImapDTO" /> class.
        /// </summary>
        /// <param name="server">Source folder (required).</param>
        /// <param name="username">Source folder (required).</param>
        ...
        public MailAccountReceiveSettingsImapDTO(string server = default(string), string username = default(string), string password = default(string), int? port = default(int?), int? connectionTimeout = default(int?), int? securityProtocol = default(int?), List<MailAccountImapFolderDTO> foldersConfiguration = default(List<MailAccountImapFolderDTO>), string className = "MailAccountReceiveSettingsImapDTO", int? authenticationMode = default(int?), string tenantId = default(string), string clientId = default(string), string clientSecret = default(string), bool? isClientSecretSet = default(bool?), bool? isAuthorizationResponseSet = default(bool?), string authorizationResponse = default(string)) : base(className, authenticationMode, tenantId, clientId, clientSecret, isClientSecretSet, isAuthorizationResponseSet, authorizationResponse)
        {
            // to ensure "server" is required (not null)
            if (server == null)
            {
                throw new InvalidDataException("server is a required property for MailAccountReceiveSettingsImapDTO and cannot be null");
            }
            else
            {
                this.Server = server;
            ...
            if (username == null)
            {
                throw new InvalidDataException("username is a required property for MailAccountReceiveSettingsImapDTO and cannot be null");
            }
            else
            {
