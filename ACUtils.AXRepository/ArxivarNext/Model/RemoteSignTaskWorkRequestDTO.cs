...
{
    /// <summary>
    /// Class of remote taskwork signature request
    /// </summary>
    [DataContract]
        public partial class RemoteSignTaskWorkRequestDTO :  IEquatable<RemoteSignTaskWorkRequestDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoteSignTaskWorkRequestDTO" /> class.
        /// </summary>
        ...
        /// <param name="signElementList">TaskWork list to sign.</param>
        public RemoteSignTaskWorkRequestDTO(int? signCertId = default(int?), string password = default(string), string relatedCertId = default(string), string otp = default(string), List<RemoteSignTaskWorkElementRequestDTO> signElementList = default(List<RemoteSignTaskWorkElementRequestDTO>))
        {
        ...
        /// </summary>
        /// <value>TaskWork list to sign</value>
        [DataMember(Name="signElementList", EmitDefaultValue=false)]
        public List<RemoteSignTaskWorkElementRequestDTO> SignElementList { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RemoteSignTaskWorkRequestDTO {\n");
        ...
        {
            return this.Equals(input as RemoteSignTaskWorkRequestDTO);
        }

        /// <summary>
        /// Returns true if RemoteSignTaskWorkRequestDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoteSignTaskWorkRequestDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoteSignTaskWorkRequestDTO input)
        {
            if (input == null)
                return false;
