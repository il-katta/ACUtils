...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
        ...
        public partial class ReportDTO :  IEquatable<ReportDTO>, IValidatableObject
    {
        ...
        public ReportDTO(List<ReportParamDTO> parameters = default(List<ReportParamDTO>), string id = default(string), string externalId = default(string), string name = default(string), string description = default(string), int? author = default(int?), string authorCompleteName = default(string), int? modifier = default(int?), string modifierCompleteName = default(string), bool? hasReportFile = default(bool?), DateTime? creationDate = default(DateTime?), DateTime? lastUpdateDate = default(DateTime?), string idFindGroup = default(string), ReportSecurityDTO security = default(ReportSecurityDTO))
        {
