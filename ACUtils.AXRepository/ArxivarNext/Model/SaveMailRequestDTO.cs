...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SaveMailRequestDTO :  IEquatable<SaveMailRequestDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SaveMailRequestDTO" /> class.
        /// </summary>
        ...
        public SaveMailRequestDTO(int? id = default(int?), bool? isBodyHtml = default(bool?), string body = default(string), string subject = default(string), int? priority = default(int?), EmailFromAddressDTO from = default(EmailFromAddressDTO), List<EmailDestinationAddressDTO> destinations = default(List<EmailDestinationAddressDTO>), List<EmailDocumentDTO> documents = default(List<EmailDocumentDTO>))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SaveMailRequestDTO {\n");
        ...
        {
            return this.Equals(input as SaveMailRequestDTO);
        }

        /// <summary>
        /// Returns true if SaveMailRequestDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SaveMailRequestDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SaveMailRequestDTO input)
        {
            if (input == null)
                return false;
