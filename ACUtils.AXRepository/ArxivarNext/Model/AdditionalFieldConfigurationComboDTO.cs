...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdditionalFieldConfigurationComboDTO : FieldBaseDTO,  IEquatable<AdditionalFieldConfigurationComboDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdditionalFieldConfigurationComboDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdditionalFieldConfigurationComboDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdditionalFieldConfigurationComboDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AdditionalFieldConfigurationComboDTO);
        }

        /// <summary>
        /// Returns true if AdditionalFieldConfigurationComboDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of AdditionalFieldConfigurationComboDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdditionalFieldConfigurationComboDTO input)
        {
            if (input == null)
                return false;
