...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SqlConditionDateTimeDTO :  IEquatable<SqlConditionDateTimeDTO>, IValidatableObject
    {
        /// <summary>
        ...
        public SqlConditionDateTimeDTO(int? _operator = default(int?), DateTime? value1 = default(DateTime?), DateTime? value2 = default(DateTime?))
        {
