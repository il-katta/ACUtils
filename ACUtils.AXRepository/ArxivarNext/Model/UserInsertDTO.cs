...
{
    /// <summary>
    /// User class for insert
    /// </summary>
    [DataContract]
        public partial class UserInsertDTO :  IEquatable<UserInsertDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserInsertDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UserInsertDTO);
        }

        /// <summary>
        /// Returns true if UserInsertDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of UserInsertDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserInsertDTO input)
        {
            if (input == null)
                return false;
