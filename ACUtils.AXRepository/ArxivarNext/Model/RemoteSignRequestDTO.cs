...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RemoteSignRequestDTO :  IEquatable<RemoteSignRequestDTO>, IValidatableObject
    {
        /// <summary>
        ...
        public List<RemoteSignElementRequestDTO> SignElementList { get; set; }
        ...
        {
            return this.Equals(input as RemoteSignRequestDTO);
        }

        /// <summary>
        /// Returns true if RemoteSignRequestDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoteSignRequestDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoteSignRequestDTO input)
        {
            if (input == null)
                return false;
