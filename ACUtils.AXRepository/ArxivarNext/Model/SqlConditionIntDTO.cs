...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SqlConditionIntDTO :  IEquatable<SqlConditionIntDTO>, IValidatableObject
    {
        /// <summary>
        ...
        public SqlConditionIntDTO(int? _operator = default(int?), int? value1 = default(int?), int? value2 = default(int?))
        {
