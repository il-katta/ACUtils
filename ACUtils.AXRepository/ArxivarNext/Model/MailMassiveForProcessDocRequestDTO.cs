...
{
    /// <summary>
    /// MailMassiveForProcessDocRequestDTO
    /// </summary>
    [DataContract]
        public partial class MailMassiveForProcessDocRequestDTO :  IEquatable<MailMassiveForProcessDocRequestDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MailMassiveForProcessDocRequestDTO" /> class.
        /// </summary>
        ...
        public List<MailMassiveForProcessDocItemRequestDTO> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MailMassiveForProcessDocRequestDTO {\n");
        ...
        {
            return this.Equals(input as MailMassiveForProcessDocRequestDTO);
        }

        /// <summary>
        /// Returns true if MailMassiveForProcessDocRequestDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of MailMassiveForProcessDocRequestDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MailMassiveForProcessDocRequestDTO input)
        {
            if (input == null)
                return false;
