...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EditProfileSchemaDTO :  IEquatable<EditProfileSchemaDTO>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as EditProfileSchemaDTO);
        }

        /// <summary>
        /// Returns true if EditProfileSchemaDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of EditProfileSchemaDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EditProfileSchemaDTO input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.EditOptions == input.EditOptions ||
                    (this.EditOptions != null &&
                    this.EditOptions.Equals(input.EditOptions))
                ) && 
                (
                ...
                (
                    ...
                    input.PostProfilationActions != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EditOptions != null)
                    hashCode = hashCode * 59 + this.EditOptions.GetHashCode();
