...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
    ...
    public partial class OriginalFieldDTO : FieldBaseDTO,  IEquatable<OriginalFieldDTO>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OriginalFieldDTO {\n");
        ...
        {
            return this.Equals(input as OriginalFieldDTO);
        }

        /// <summary>
        /// Returns true if OriginalFieldDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of OriginalFieldDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OriginalFieldDTO input)
        {
            if (input == null)
                return false;
