...
namespace ACUtils.AXRepository.ArxivarNext.Model
{
    ...
    public partial class ImportantFieldDTO : FieldBaseDTO,  IEquatable<ImportantFieldDTO>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImportantFieldDTO {\n");
        ...
        {
            return this.Equals(input as ImportantFieldDTO);
        }

        /// <summary>
        /// Returns true if ImportantFieldDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of ImportantFieldDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImportantFieldDTO input)
        {
            if (input == null)
                return false;
