...
namespace ACUtils.AXRepository.ArxivarNext.Client
{
        ...
        public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "2.5.26";
        ...
        {
            UserAgent = "Swagger-Codegen/2.5.26/csharp";
            BasePath = "http://arxivar.local/ARXivarNextWebApi";
        ...
        public Configuration(
            ...
            string basePath = "http://arxivar.local/ARXivarNextWebApi") : this()
        {
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "Swagger-Codegen/2.5.26/csharp"
        ...
        {
            String report = "C# SDK (ACUtils.AXRepository.ArxivarNext) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: data\n";
            report += "    SDK Package Version: 2.5.26\n";
