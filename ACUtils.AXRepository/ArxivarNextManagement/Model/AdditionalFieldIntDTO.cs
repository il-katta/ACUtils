...
{
    /// <summary>
    /// Class of Additional fields for Numeric type
    /// </summary>
    [DataContract]
    public partial class AdditionalFieldIntDTO : FieldBaseDTO,  IEquatable<AdditionalFieldIntDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdditionalFieldIntDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdditionalFieldIntDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdditionalFieldIntDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AdditionalFieldIntDTO);
        }

        /// <summary>
        /// Returns true if AdditionalFieldIntDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of AdditionalFieldIntDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdditionalFieldIntDTO input)
        {
            if (input == null)
                return false;
