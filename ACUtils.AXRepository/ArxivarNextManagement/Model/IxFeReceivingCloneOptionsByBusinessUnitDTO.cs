...
{
    /// <summary>
    /// Class for cloning receiving settings by business unit for IX-FE
    /// </summary>
    [DataContract]
    public partial class IxFeReceivingCloneOptionsByBusinessUnitDTO :  IEquatable<IxFeReceivingCloneOptionsByBusinessUnitDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IxFeReceivingCloneOptionsByBusinessUnitDTO" /> class.
        /// </summary>
        ...
        public IxFeReceivingCloneOptionsByBusinessUnitDTO(string originalBusinessUnitCode = default(string), List<string> businessUnitCodes = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IxFeReceivingCloneOptionsByBusinessUnitDTO {\n");
        ...
        {
            return this.Equals(input as IxFeReceivingCloneOptionsByBusinessUnitDTO);
        }

        /// <summary>
        /// Returns true if IxFeReceivingCloneOptionsByBusinessUnitDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of IxFeReceivingCloneOptionsByBusinessUnitDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IxFeReceivingCloneOptionsByBusinessUnitDTO input)
        {
            if (input == null)
                return false;
