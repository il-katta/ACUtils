...
{
    /// <summary>
    /// Class of IX-CE sending settings
    /// </summary>
    [DataContract]
    public partial class IxCeSendingSettingsDTO :  IEquatable<IxCeSendingSettingsDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IxCeSendingSettingsDTO" /> class.
        /// </summary>
        ...
        public IxCeSendingSettingsDTO(int? id = default(int?), string businessUnitCode = default(string), int? priority = default(int?), DocumentTypeSimpleDTO documentType = default(DocumentTypeSimpleDTO), FindSimpleDTO search = default(FindSimpleDTO), bool? enabled = default(bool?), bool? hasCustomCredentials = default(bool?))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IxCeSendingSettingsDTO {\n");
        ...
        {
            return this.Equals(input as IxCeSendingSettingsDTO);
        }

        /// <summary>
        /// Returns true if IxCeSendingSettingsDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of IxCeSendingSettingsDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IxCeSendingSettingsDTO input)
        {
            if (input == null)
                return false;
