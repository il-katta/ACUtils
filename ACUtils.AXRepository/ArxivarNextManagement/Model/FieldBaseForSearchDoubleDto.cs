...
namespace ACUtils.AXRepository.ArxivarNextManagement.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FieldBaseForSearchDoubleDto : FieldBaseForSearchDTO,  IEquatable<FieldBaseForSearchDoubleDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FieldBaseForSearchDoubleDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FieldBaseForSearchDoubleDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FieldBaseForSearchDoubleDto" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as FieldBaseForSearchDoubleDto);
        }

        /// <summary>
        /// Returns true if FieldBaseForSearchDoubleDto instances are equal
        /// </summary>
        /// <param name="input">Instance of FieldBaseForSearchDoubleDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FieldBaseForSearchDoubleDto input)
        {
            if (input == null)
                return false;
