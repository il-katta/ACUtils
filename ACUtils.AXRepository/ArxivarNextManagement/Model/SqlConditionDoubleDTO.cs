...
namespace ACUtils.AXRepository.ArxivarNextManagement.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SqlConditionDoubleDTO : SqlConditionBaseDTO,  IEquatable<SqlConditionDoubleDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SqlConditionDoubleDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SqlConditionDoubleDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SqlConditionDoubleDTO" /> class.
        /// </summary>
        ...
        public SqlConditionDoubleDTO(int? _operator = default(int?), double? value1 = default(double?), double? value2 = default(double?), string className = "SqlConditionDoubleDTO", string id = default(string), string name = default(string), string table = default(string), string field = default(string), bool? insensitiveSearch = default(bool?), string external1 = default(string), string external1Description = default(string), string external2 = default(string), string external2Description = default(string)) : base(className, id, name, table, field, insensitiveSearch, external1, external1Description, external2, external2Description)
        {
