...
namespace ACUtils.AXRepository.ArxivarNextManagement.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FieldBaseForSearchContactDto : FieldBaseForSearchDTO,  IEquatable<FieldBaseForSearchContactDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FieldBaseForSearchContactDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FieldBaseForSearchContactDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FieldBaseForSearchContactDto" /> class.
        /// </summary>
        ...
        public ContactSearchFilterDto Valore1 { get; set; }
        ...
        public ContactSearchFilterDto Valore2 { get; set; }
        ...
        {
            return this.Equals(input as FieldBaseForSearchContactDto);
        }

        /// <summary>
        /// Returns true if FieldBaseForSearchContactDto instances are equal
        /// </summary>
        /// <param name="input">Instance of FieldBaseForSearchContactDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FieldBaseForSearchContactDto input)
        {
            if (input == null)
                return false;
