...
namespace ACUtils.AXRepository.ArxivarNextManagement.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IxCeBusinessUnitSettingsDTO :  IEquatable<IxCeBusinessUnitSettingsDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IxCeBusinessUnitSettingsDTO" /> class.
        /// </summary>
        ...
        public IxCeBusinessUnitSettingsDTO(int? id = default(int?), BusinessUnitDTO arxBusinessUnit = default(BusinessUnitDTO), IxBusinessUnitSimpleDTO ixBusinessUnit = default(IxBusinessUnitSimpleDTO), bool? enabled = default(bool?), IxCredentialsDTO credentials = default(IxCredentialsDTO))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IxCeBusinessUnitSettingsDTO {\n");
        ...
        {
            return this.Equals(input as IxCeBusinessUnitSettingsDTO);
        }

        /// <summary>
        /// Returns true if IxCeBusinessUnitSettingsDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of IxCeBusinessUnitSettingsDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IxCeBusinessUnitSettingsDTO input)
        {
            if (input == null)
                return false;
