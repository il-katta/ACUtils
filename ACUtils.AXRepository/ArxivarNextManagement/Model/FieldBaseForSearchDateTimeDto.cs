...
namespace ACUtils.AXRepository.ArxivarNextManagement.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FieldBaseForSearchDateTimeDto : FieldBaseForSearchDTO,  IEquatable<FieldBaseForSearchDateTimeDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FieldBaseForSearchDateTimeDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FieldBaseForSearchDateTimeDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FieldBaseForSearchDateTimeDto" /> class.
        /// </summary>
        ...
        public DateTime? Valore1 { get; set; }
        ...
        public DateTime? Valore2 { get; set; }
        ...
        {
            return this.Equals(input as FieldBaseForSearchDateTimeDto);
        }

        /// <summary>
        /// Returns true if FieldBaseForSearchDateTimeDto instances are equal
        /// </summary>
        /// <param name="input">Instance of FieldBaseForSearchDateTimeDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FieldBaseForSearchDateTimeDto input)
        {
            if (input == null)
                return false;
