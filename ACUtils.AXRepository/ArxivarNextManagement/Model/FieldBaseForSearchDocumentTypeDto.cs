...
namespace ACUtils.AXRepository.ArxivarNextManagement.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FieldBaseForSearchDocumentTypeDto : FieldBaseForSearchDTO,  IEquatable<FieldBaseForSearchDocumentTypeDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FieldBaseForSearchDocumentTypeDto" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FieldBaseForSearchDocumentTypeDto() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FieldBaseForSearchDocumentTypeDto" /> class.
        /// </summary>
        ...
        public DocumentTypeSearchFilterDto Valore1 { get; set; }
        ...
        public DocumentTypeSearchFilterDto Valore2 { get; set; }
        ...
        {
            return this.Equals(input as FieldBaseForSearchDocumentTypeDto);
        }

        /// <summary>
        /// Returns true if FieldBaseForSearchDocumentTypeDto instances are equal
        /// </summary>
        /// <param name="input">Instance of FieldBaseForSearchDocumentTypeDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FieldBaseForSearchDocumentTypeDto input)
        {
            if (input == null)
                return false;
