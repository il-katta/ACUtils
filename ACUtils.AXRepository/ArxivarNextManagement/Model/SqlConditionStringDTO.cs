...
namespace ACUtils.AXRepository.ArxivarNextManagement.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SqlConditionStringDTO : SqlConditionBaseDTO,  IEquatable<SqlConditionStringDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SqlConditionStringDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SqlConditionStringDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SqlConditionStringDTO" /> class.
        /// </summary>
        ...
        public SqlConditionStringDTO(int? _operator = default(int?), string value1 = default(string), string value2 = default(string), string className = "SqlConditionStringDTO", string id = default(string), string name = default(string), string table = default(string), string field = default(string), bool? insensitiveSearch = default(bool?), string external1 = default(string), string external1Description = default(string), string external2 = default(string), string external2Description = default(string)) : base(className, id, name, table, field, insensitiveSearch, external1, external1Description, external2, external2Description)
        {
