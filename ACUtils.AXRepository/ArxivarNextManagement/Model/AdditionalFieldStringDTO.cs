...
namespace ACUtils.AXRepository.ArxivarNextManagement.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdditionalFieldStringDTO : FieldBaseDTO,  IEquatable<AdditionalFieldStringDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdditionalFieldStringDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdditionalFieldStringDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdditionalFieldStringDTO" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AdditionalFieldStringDTO);
        }

        /// <summary>
        /// Returns true if AdditionalFieldStringDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of AdditionalFieldStringDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdditionalFieldStringDTO input)
        {
            if (input == null)
                return false;
