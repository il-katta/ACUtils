...
namespace ACUtils.AXRepository.ArxivarNextManagement.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BusinessUnitForOperationsDTO :  IEquatable<BusinessUnitForOperationsDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BusinessUnitForOperationsDTO" /> class.
        /// </summary>
        /// <param name="domainPassword">Domain password.</param>
        /// <param name="archiveDbPassword">Archive Db password.</param>
        ...
        /// Domain password
        /// </summary>
        /// <value>Domain password</value>
        [DataMember(Name="domainPassword", EmitDefaultValue=false)]
        public string DomainPassword { get; set; }

        /// <summary>
        /// Archive Db password
        /// </summary>
        /// <value>Archive Db password</value>
        [DataMember(Name="archiveDbPassword", EmitDefaultValue=false)]
        public string ArchiveDbPassword { get; set; }

        /// <summary>
        /// Db password
        /// </summary>
        /// <value>Db password</value>
        [DataMember(Name="dbPassword", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BusinessUnitForOperationsDTO {\n");
        ...
        {
            return this.Equals(input as BusinessUnitForOperationsDTO);
        }

        /// <summary>
        /// Returns true if BusinessUnitForOperationsDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of BusinessUnitForOperationsDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BusinessUnitForOperationsDTO input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.DomainPassword == input.DomainPassword ||
                    (this.DomainPassword != null &&
                    this.DomainPassword.Equals(input.DomainPassword))
                ) && 
                (
                    this.ArchiveDbPassword == input.ArchiveDbPassword ||
                    (this.ArchiveDbPassword != null &&
                    this.ArchiveDbPassword.Equals(input.ArchiveDbPassword))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DomainPassword != null)
                    hashCode = hashCode * 59 + this.DomainPassword.GetHashCode();
                if (this.ArchiveDbPassword != null)
                    hashCode = hashCode * 59 + this.ArchiveDbPassword.GetHashCode();
