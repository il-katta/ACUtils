...
{
    /// <summary>
    /// Class of SQL connection strings
    /// </summary>
    [DataContract]
    public partial class SqlConnectionDTO :  IEquatable<SqlConnectionDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SqlConnectionDTO" /> class.
        /// </summary>
        ...
        public SqlConnectionDTO(string id = default(string), string name = default(string), string connectionString = default(string), string user = default(string), string password = default(string), int? connectionType = default(int?))
        {
            this.Id = id;
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SqlConnectionDTO {\n");
        ...
        {
            return this.Equals(input as SqlConnectionDTO);
        }

        /// <summary>
        /// Returns true if SqlConnectionDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SqlConnectionDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SqlConnectionDTO input)
        {
            if (input == null)
                return false;
