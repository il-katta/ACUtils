...
{
    /// <summary>
    /// Class of document type: archive options
    /// </summary>
    [DataContract]
    public partial class ArchiveOptionsDTO :  IEquatable<ArchiveOptionsDTO>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ArchiveOptionsDTO {\n");
        ...
        {
            return this.Equals(input as ArchiveOptionsDTO);
        }

        /// <summary>
        /// Returns true if ArchiveOptionsDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of ArchiveOptionsDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArchiveOptionsDTO input)
        {
            if (input == null)
                return false;
