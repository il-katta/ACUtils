...
namespace ACUtils.AXRepository.ArxivarNextManagement.Api
{
    ...
    public interface IApiCallManagementApi : IApiAccessor
    {
        ...
        Object ApiCallManagementTestApiCall (ApiCallForTestDTO apiCallForTest);
        ...
        ApiResponse<Object> ApiCallManagementTestApiCallWithHttpInfo (ApiCallForTestDTO apiCallForTest);
        /// <summary>
        ...
        System.Threading.Tasks.Task<Object> ApiCallManagementTestApiCallAsync (ApiCallForTestDTO apiCallForTest);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> ApiCallManagementTestApiCallAsyncWithHttpInfo (ApiCallForTestDTO apiCallForTest);
        /// <summary>
        /// This method updates specific API call
        /// </summary>
        /// <remarks>
    ...
    public partial class ApiCallManagementApi : IApiCallManagementApi
    {
        ...
        /// <returns></returns>
        public ApiCallManagementApi(ACUtils.AXRepository.ArxivarNextManagement.Client.Configuration configuration = null)
        {
        ...
        /// <param name="apiCallForTest">API call data</param>
        /// <returns>Object</returns>
        public Object ApiCallManagementTestApiCall (ApiCallForTestDTO apiCallForTest)
        {
             ApiResponse<Object> localVarResponse = ApiCallManagementTestApiCallWithHttpInfo(apiCallForTest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="apiCallForTest">API call data</param>
        /// <returns>ApiResponse of Object</returns>
        public ApiResponse< Object > ApiCallManagementTestApiCallWithHttpInfo (ApiCallForTestDTO apiCallForTest)
        {
            // verify the required parameter 'apiCallForTest' is set
            if (apiCallForTest == null)
                throw new ApiException(400, "Missing required parameter 'apiCallForTest' when calling ApiCallManagementApi->ApiCallManagementTestApiCall");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ApiCallManagementTestApiCall", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="apiCallForTest">API call data</param>
        /// <returns>Task of Object</returns>
        public async System.Threading.Tasks.Task<Object> ApiCallManagementTestApiCallAsync (ApiCallForTestDTO apiCallForTest)
        {
             ApiResponse<Object> localVarResponse = await ApiCallManagementTestApiCallAsyncWithHttpInfo(apiCallForTest);
             return localVarResponse.Data;
        ...
        /// <param name="apiCallForTest">API call data</param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> ApiCallManagementTestApiCallAsyncWithHttpInfo (ApiCallForTestDTO apiCallForTest)
        {
            // verify the required parameter 'apiCallForTest' is set
            if (apiCallForTest == null)
                throw new ApiException(400, "Missing required parameter 'apiCallForTest' when calling ApiCallManagementApi->ApiCallManagementTestApiCall");
