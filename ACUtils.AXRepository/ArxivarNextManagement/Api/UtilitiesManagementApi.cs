...
namespace ACUtils.AXRepository.ArxivarNextManagement.Api
{
    ...
    public interface IUtilitiesManagementApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="ACUtils.AXRepository.ArxivarNextManagement.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="fieldManagementMode">Possible values:  0: Standard  1: UniquenessRules  2: Folders  3: SqlQuery  4: ApiCall  5: DataSource  6: AdditionalFieldSource  7: AdditionalFieldDestination  8: Formula  9: Additional  10: IxFeRuleMapping  11: IxFePPMapping  12: IxCeArxCe  13: RootMask </param>
    ...
    public partial class UtilitiesManagementApi : IUtilitiesManagementApi
    {
        ...
        /// <returns></returns>
        public UtilitiesManagementApi(ACUtils.AXRepository.ArxivarNextManagement.Client.Configuration configuration = null)
        {
